...
## 2025-11 — Webhooks & events, Open WebUI compatibility

- Tested and confirmed compatibility with [Open WebUI](https://openwebui.com/), enabling users to monetize models served through this popular open-source interface. See the [integration guide](/how-to-guides/use-paywalls-with-openwebui) for setup instructions.
