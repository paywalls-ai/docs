...
Providing a user id is mandatory for all billable endpoints (e.g., `/chat/completions`, `/user/charge`).
...
Note: If your auth system changes, keep a mapping in your app so you can continue sending a stable id to Paywalls.
...
- See `more/security-compliance.mdx` and `privacy.mdx` for details.
...
For concrete examples in Node, Python, cURL, and Vercel AI SDK, see `how-to-guides/pass-user-id.mdx`.
