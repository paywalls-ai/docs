...
<Step title="Identify and authorize the user">
...
<Step title="Handle failed authorizations">
If the user’s balance is low or they are not authorized charges:
