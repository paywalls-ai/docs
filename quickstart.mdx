...
<Note>
  **Note:** You can pass the user ID in the request body (`user` property) or in an `X-Paywall-User` header. [Learn more about User Identification](/paywall/user-identification).
</Note>
