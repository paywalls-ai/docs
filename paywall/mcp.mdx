---
title: "MCP"
description: "This guide shows how to charge users for MCP (Model Context Protocol) tools using the Paywalls.ai charging endpoint before executing the tool action. "
icon: "waypoints"
---
...
**_Q: Can I charge after the tool runs?_**\
