...
### \*\*Option 1: \*\*`user`**field in the request body**  ✅ _Recommended for OpenAI-compatible clients_
...
### \*\*Option 2: \*\*`X-Paywall-User`**header**  ✅ _Best for middleware injection_
...
### **Option 3: URL Path Parameter** ⚠ _Fallback when nothing else fits your system_
