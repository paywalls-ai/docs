---
title: "Paywalls.ai"
description: "Prepaid wallet with fiat and crypto payments."
---

### Overview

[Paywalls.ai](http://Paywalls.ai) by default uses a prepaid wallet model to control and monetize access to LLM APIs. Before a user can interact with your app through the proxy, they must:
...
This payment method doesn't require you to connect any crypto or stripe account. Everything works automatically out of the box. We handle user payments and you can withdraw paywall earnings to any crypto wallet.